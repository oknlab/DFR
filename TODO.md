...
7. [~] Add **OpenAPI route introspection** from registered routes and dependency metadata (operationId/summary/dependency + return-type metadata implemented; full request/response schema extraction pending).
